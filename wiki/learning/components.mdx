...
<Callout variant="warning">
    There is another class not mentioned: the _**HealthBarVariables**_ class, witch contains all the variables the library on the rendering system. This class should never be accessed directly,
    since all the variables can be overridden through the methods inside the _**HealthComponent**_ class.
</Callout>
