...
## What does these methods do? **Set methods**
----
...
## What does these methods do? **Override methods**
...
This means that in the name od the method you know exactly what you are overriding. For example, using this method:

- overrideWitheredHalfHeartBlinking(...).

You will override the texture of the withered type of heart, but in his half form, ONLY while it is blinking (so the damage blinking).